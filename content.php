...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
	...
	elseif ($_GET['module'] == 'citas') {
		include "modules/citas/view.php";
	}
		elseif ($_GET['module'] == 'new_cita') {
		include "modules/citas/form.php";
	}


	elseif ($_GET['module'] == 'pacientes') {
		include "modules/pacientes/view.php";
	}
	elseif ($_GET['module'] == 'new_pacientes') {
		include "modules/pacientes/form.php";
	}
	elseif ($_GET['module'] == 'especialidades') {
		include "modules/especialidades/view.php";
	}
	elseif ($_GET['module'] == 'new_especialidad') {
